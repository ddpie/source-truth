...
grounding and failure retention. These offline tests do not prove customer IAM/model availability
or production answer quality and cost. The deployment's `e2e-probe.py --smoke` requires a
